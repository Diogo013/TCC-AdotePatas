...
<head>
    ...
    <title>Termos de Uso - Adote Patas</title>
    ...
    <link rel="stylesheet" href="assets/css/pages/termos-de-uso/termos.css">
</head>
<body>
...
<main class="termos-section" id="termos-de-uso">
  <div class="container">
    
    <div class="row">
      <div class="col-12">
        <div class="termos-header text-center mb-5">
          <h1 class="section-title-kawaii">Termos de Uso</h1>
          <p class="section-subtitle-poppins">Leia com atenção os termos de uso do Adote Patas</p>
        </div>
      </div>
    </div>
    ...
    <div class="row justify-content-center">
      <div class="col-lg-10">
        <div class="termos-content">
          ...
          <div class="termos-intro">
            <p>Este site foi desenvolvido como parte de um Trabalho de Conclusão de Curso (TCC) e tem o objetivo de aproximar pessoas interessadas em adotar pets de ONGs e protetores.</p>
          </div>

          <div class="termos-item">
            <h2><i class="bi bi-1-circle-fill"></i> Uso do site</h2>
            <p>Ao utilizar o Adote Patas, você concorda em:</p>
            <ul>
              <li>Fornecer informações verdadeiras.</li>
              <li>Não utilizar o site para fins ilegais ou prejudiciais.</li>
              <li>Não tentar alterar ou comprometer o funcionamento da plataforma.</li>
            </ul>
          </div>

          <div class="termos-item">
            <h2><i class="bi bi-2-circle-fill"></i> Sobre o processo de adoção</h2>
            <p>O Adote Patas atua como intermediário entre adotantes e responsáveis pelos animais.</p>
            <p>Por isso:</p>
            <ul>
              <li>Não finalizamos adoções.</li>
              <li>Não nos responsabilizamos por acordos feitos diretamente entre adotante e responsável.</li>
              <li>Nosso propósito é facilitar a comunicação e oferecer um ambiente funcional para o processo.</li>
            </ul>
          </div>

          <div class="termos-item">
            <h2><i class="bi bi-3-circle-fill"></i> Natureza acadêmica do projeto</h2>
            <p>O Adote Patas é um sistema criado exclusivamente para fins educacionais e não possui fins lucrativos. Algumas limitações podem existir devido ao caráter acadêmico do projeto.</p>
          </div>

          <div class="termos-item">
            <h2><i class="bi bi-4-circle-fill"></i> Propriedade intelectual</h2>
            <p>Todo o conteúdo do Adote Patas, incluindo textos, imagens próprias e estrutura do site, é protegido por direitos autorais. Não é permitido copiar ou distribuir sem autorização.</p>
          </div>

          <div class="termos-item">
            <h2><i class="bi bi-5-circle-fill"></i> Atualizações</h2>
            <p>Podemos atualizar estes Termos de Uso quando necessário, sempre buscando mais clareza e melhoria contínua.</p>
          </div>

          <div class="termos-footer text-center mt-5">
