document.addEventListener('DOMContentLoaded', function () {
    ...
    const recoverySuccessState = document.getElementById('recovery-success-state');
    ...
    if (forgotPasswordLink && modal && closeModalBtn && recoveryForm) {
        ...
        recoveryForm.addEventListener('submit', (e) => {
            ...
            const emailConfirm = document.getElementById('email_confirmar').value;

            if (!email || !emailConfirm) {
                modalErrorMsg.textContent = 'Por favor, preencha os dois campos de e-mail.';
                modalErrorMsg.classList.remove('hidden');
                return;
            }
            if (email !== emailConfirm) {
                modalErrorMsg.textContent = 'Os e-mails não coincidem. Tente novamente.';
                modalErrorMsg.classList.remove('hidden');
                return;
            }
